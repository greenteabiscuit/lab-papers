...
which consists of an integer number of multiples of a half-wavelength.
...
When using explicit components, the above equation can be rewritten as follows.
...
Electromagnetic fields that die off instead of propagate are called evanescent waves.
...
for this problem.
This condition is referred to as a radiation condition.
...
used both as the analyzer and the signal generator.
...
to see the geometrical effect on the beamwidth and reflective characteristics.
