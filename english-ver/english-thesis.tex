...
\begin{itemize}
  ...
  \item[] \textbf{Risk of data breach}
  Due to its high frequency,
  mmWaves can deliver higher throughput and capacity.
  However, threats such as TEMPEST attacks and
  power analysis attacks can pose a great risk to privacy and data breach.
\end{itemize}
