...
We thank the various senior students and staff in the lab. They
...
\begin{itemize}
  ...
  statement. Finally, we describe the existing methods and their limitations \\
...
the phase will need to be considered additional to the amplitude.
...
When using explicit components, the equation above can be rewritten as follows.
